...
namespace TicTacToeServer
{
    public partial class Form1 : Form
    {
        ...
        private static ManualResetEvent choicesignal = new ManualResetEvent(false);
        private static ManualResetEvent gamecontinuation = new ManualResetEvent(false);
        ...
        private void Accept()
        {
            while (listen)
            {
                try
                {
                    ...
                    if (!Clients.ContainsKey(potname)) //Name exists accept connection
                    {
        ...
        private void StartGame()
        {
            ...
            try
            {
                ...
                {
                    Byte[] gameinfobuffer;
                    string gameinfo = ":10:~~~~~~~~~\nGame Starts | " + players[0] + ": " + playerscores[0] + " vs. " + players[1] + ": " + playerscores[1] + "\n---------\n";
